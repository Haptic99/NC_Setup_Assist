        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    WerkzeugKategorieID = table.Column<int>(type: "INTEGER", nullable: false),
                    BenötigtRadius = table.Column<bool>(type: "INTEGER", nullable: false),
                    BenötigtSteigung = table.Column<bool>(type: "INTEGER", nullable: false),
                    BenötigtSpitzenwinkel = table.Column<bool>(type: "INTEGER", nullable: false),
                    BenötigtDurchmesser = table.Column<bool>(type: "INTEGER", nullable: false),
                    BenötigtBreite = table.Column<bool>(type: "INTEGER", nullable: false),
                    BenötigtMaxStechtiefe = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Spitzenwinkel = table.Column<double>(type: "REAL", nullable: true),
                    Durchmesser = table.Column<double>(type: "REAL", nullable: true),
                    Breite = table.Column<double>(type: "REAL", nullable: true),
                    MaxStechtiefe = table.Column<double>(type: "REAL", nullable: true),
                    WerkzeugUnterkategorieID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FräserAusrichtung = table.Column<string>(type: "TEXT", nullable: true),
                    FavoritKategorie = table.Column<string>(type: "TEXT", nullable: true),
                    FavoritUnterkategorie = table.Column<string>(type: "TEXT", nullable: true),
                    VerwendetKorb = table.Column<bool>(type: "INTEGER", nullable: false),
                    NCProgrammID = table.Column<int>(type: "INTEGER", nullable: false),
