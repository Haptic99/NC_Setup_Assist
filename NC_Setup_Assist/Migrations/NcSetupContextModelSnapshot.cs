...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NC_Setup_Assist.Models.Projekt", b =>
                {
                    ...
                    b.Property<DateTime>("AnalyseDatum")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NC_Setup_Assist.Models.WerkzeugEinsatz", b =>
                {
                    ...
                    b.Property<int>("KorrekturNummer")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NC_Setup_Assist.Models.Projekt", b =>
                {
                    b.HasOne("NC_Setup_Assist.Models.NCProgramm", "ZugehoerigesNCProgramm")
                        .WithMany()
                        .HasForeignKey("NCProgrammID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ZugehoerigesNCProgramm");
                });
            ...
            modelBuilder.Entity("NC_Setup_Assist.Models.Standort", b =>
                {
                    b.HasOne("NC_Setup_Assist.Models.Firma", "ZugehoerigeFirma")
                        .WithMany("Standorte")
                        .HasForeignKey("FirmenID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ZugehoerigeFirma");
                });
